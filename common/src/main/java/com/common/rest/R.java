...
public class R<T> implements Serializable {
    ...
    public static R<?> runtimeFail(String msg){
        return new R<>(RestCode.SERVICE_UNAVAILABLE.code, msg, null);
    }

    public static R<?> openFail(String msg){
        return new R<>(RestCode.OPEN_FAIL.code, msg, null);
    }
